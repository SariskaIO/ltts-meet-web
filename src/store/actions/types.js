...
export const SET_ANNOTATION_FEATURE = "SET_ANNOTATION_FEATURE";
export const REMOVE_ANNOTATION_FEATURE = "REMOVE_ANNOTATION_FEATURE";
export const SET_ANNOTATION_PEN = "SET_ANNOTATION_PEN";
export const SET_ANNOTATION_EMOJI = "SET_ANNOTATION_EMOJI";
export const SET_ANNOTATION_CIRCLE = "SET_ANNOTATION_CIRCLE";
export const SET_ANNOTATION_TEXTBOX = "SET_ANNOTATION_TEXTBOX";
export const CLEAR_ALL_ANNOTATION = "CLEAR_ALL_ANNOTATION";

export const SET_ANNOTATION_STYLE= "SET_ANNOTATION_STYLE";
export const SET_ANNOTATION_COLOR= "SET_ANNOTATION_COLOR";
export const SET_ANNOTATION_WIDTH = "SET_ANNOTATION_WIDTH";