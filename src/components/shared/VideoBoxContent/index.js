import {
  ...
  const VideoBoxContent = ({
    ...
    return (
      <>
        ...
        {videoTrack?.isMuted() ? (
          <Box className={avatarActiveClasses}>
            <UserAvatar 
              ...
              audioIndicatorActiveClasses={audioIndicatorActiveClasses} 
        ...
        {!isFilmstrip && (
          <Box>
            <AudioLevelIndicator key={audioLevel} passedAudioLevel={audioLevel} />
          </Box>
        )}
  ...
  export default VideoBoxContent;
